    ...
    <>
      ...
      <div>
        ...
        >
          ...
          low: <input type="number"   placeholder="0"    onChange={(e)=>setLow(e.target.value)}/>
          high: <input type="number"  placeholder="25000" onChange={(e)=>setHigh(e.target.value)} />
          
          </>:
          <>
          <button onClick={()=> setCategory("laptop")}>laptop</button> <button  onClick={()=> setCategory("vehicles")}>Vehicles</button>
          </>
